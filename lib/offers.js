...
function processOffers(offers) {
  ...
  offers
    // sort offers by date ascending to process offers is the correct order
    // and handle revoke and grants that happen at the same time
    .sort((a, b) => {
